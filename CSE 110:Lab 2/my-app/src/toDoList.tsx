 ...
 return (
   <div className="App">
     <div className="App-body">
        ...
        <h2>{`Items bought: ${numRemainingItems}`}</h2>
        <br />
       <form action=".">
         {items.map((item,index) => ListItem(item, handleCheckboxClick, index))}
       </form>
     </div>
   </div>
 );
...
function ListItem(item: GroceryItem, changeHandler: ChangeEventHandler, index: number) {
 return (
   <div  key={index}>
     <input
